    ...
    <div>
      ...
      <div className="p-16 bg-[#162649]">
        ...
        >
          ...
          {!isMonthly ? (
            <div className="mx-4 grid grid-cols-1lg:grid-cols-2  xl:grid-cols-3 pb-6 justify-items-center gap-y-8">
            ...
            <div className="mx-4 grid grid-cols-1 lg:grid-cols-2  xl:grid-cols-3 pb-6 justify-items-center gap-y-8">
              <div className="card-member font-primary">
                <div className="content-membership">
                  <div className="text-5xl font-bold font-primary text-white">
                    Hole-in-One
